...
CREATE TABLE CUSTOMERS (
  ...
  password VARCHAR(100) NOT NULL, -- Note: should store hashed passwords
...
CREATE TABLE ORGANISER (
  ...
  org_company_logo VARCHAR(100) UNIQUE NOT NULL,
...
-- EMAIL_VERIFICATION Table (polymorphic user reference)
